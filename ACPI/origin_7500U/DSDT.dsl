 ...
 *
 * Disassembly of DSDT.aml, Wed Apr  3 18:08:51 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001C9CC (117196)
 *     Revision         0x02
 *     Checksum         0xFD
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x6FF6C018, 0x070F)
    ...
    OperationRegion (OGNS, SystemMemory, 0x6FF6CFD8, 0x0000000C)
    ...
    Scope (_SB.PCI0.I2C0)
    {
        Device (TPD0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (SBFI, \_SB.PCI0.I2C0.TPD0._CRS._Y1D._INT, INT2)  // _INT: Interrupts
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (TPL1)
        {
            ...
            CreateWordField (SBFB, \_SB.PCI0.I2C1.TPL1._Y1E._ADR, BADR)  // _ADR: Address
            CreateDWordField (SBFB, \_SB.PCI0.I2C1.TPL1._Y1E._SPE, SPED)  // _SPE: Speed
            CreateDWordField (SBFI, \_SB.PCI0.I2C1.TPL1._Y1F._INT, INT2)  // _INT: Interrupts
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC0)
        {
            ...
            Scope (\)
            {
                OperationRegion (LFCN, SystemMemory, 0x6F88DE58, 0x00E8)
    ...
    OperationRegion (MDBG, SystemMemory, 0x6FF59018, 0x00001004)
